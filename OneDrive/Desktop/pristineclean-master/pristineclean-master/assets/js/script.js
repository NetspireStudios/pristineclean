...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Note: Submit button handling is done in hero-form.js
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (navbar) {
        // Initially show navbar (no transition on page load)
        navbar.classList.add('navbar-visible');
        navbar.classList.remove('navbar-hidden');
        
        // Add transition class after a short delay (prevents animation on page load)
        setTimeout(() => {
            navbar.classList.add('has-transition');
        }, 100);
